...
public class CPersona {
    ...
    public ResponseEntity<?> create(@RequestBody dtoPersona dtopersona){
        ...
        Persona persona = new Persona(dtopersona.getNombre(),dtopersona.getApellido(), dtopersona.getImg(), dtopersona.getFecha(), dtopersona.getTelefono(), dtopersona.getCiudad(), dtopersona.getEmail(), dtopersona.getDireccion(), dtopersona.getNacionalidad(), dtopersona.getProfesion(), dtopersona.getAcerca(), dtopersona.getDemi());
        sPersona.save(persona);
